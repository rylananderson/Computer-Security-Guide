...
public class sysRestoreScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sys_restore_screen);

        //Video Stuff
        VideoView videoViewer = findViewById(R.id.video_view);
        String videoPath = "android.resource://" + getPackageName() +"/" + R.raw.sys_restore;
        ...
        backBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent virusHelpScreen = new Intent(sysRestoreScreen.this, VirusHelpScreen.class);
