...
public class fireVidScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fire_vid_screen);

        //Video Stuff
        VideoView videoViewer = findViewById(R.id.video_view);
        String videoPath = "android.resource://" + getPackageName() +"/" + R.raw.enable_firewall;
        ...
        backBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent virusHelpScreen = new Intent(fireVidScreen.this, VirusHelpScreen.class);
