...
public class malScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mal_screen);

        //Video Stuff
        VideoView videoViewer = findViewById(R.id.video_view);
        String videoPath = "android.resource://" + getPackageName() +"/" + R.raw.download_bytes;
        ...
        backBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent virusHelpScreen = new Intent(malScreen.this, VirusHelpScreen.class);
